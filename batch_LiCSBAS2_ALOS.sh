...
# LiCSBAS_ALOS steps:
#  01: LiCSBAS01_get_geotiff_ALOS.py
...
p01_start_date=""	# default: 20060201
p01_end_date=""	# default: 20110801
p01_unwrate_min="" # default: 0.3
...
p16_deg_deramp="2"	# 1, bl, or 2. default: no deramp
p16_demerr="y"	# y/n. default: n
...
p01_frame=""	# e.g. 406_0710_343 
p01_n_para=""	# default: 4
p01_bperp_max=""	# default: 10000 m
p01_dt_max=""	# default: 2000 days
p02_GEOCdir=""	# default: GEOC
p02_GEOCmldir=""	# default: GEOCml$nlook
p02_freq="1.27e9"	# default: 5.405e9 Hz
...
if [ $start_step -le 01 -a $end_step -ge 01 ];then
  ...
  if [ $check_only == "y" ];then
    echo "LiCSBAS01_get_geotiff_ALOS.py $p01_op"
  else
    LiCSBAS01_get_geotiff_ALOS.py $p01_op 2>&1 | tee -a $log
